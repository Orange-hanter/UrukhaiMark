...
- [datamatrix-spec.md](../reference/datamatrix-spec.md) — структура КМ
- [troubleshooting.md](troubleshooting.md) — типичные ошибки
- [equipment.md](../explanation/technology/equipment.md) — верификаторы и сканеры
- [export-rf-cosmetics.md](export-rf-cosmetics.md) — отчётность
