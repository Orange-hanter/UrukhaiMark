...
Рекомендации по размещению GS1 DataMatrix и УКЗ в зависимости от типа упаковки. Требования операторов ЕАЭС сформулированы обобщённо; для конкретного SKU сверяйтесь с [product-matrix.md](../../reference/product-matrix.md) и базой знаний [kb.belblank.by](https://kb.belblank.by/).
...
- [quality-control.md](../../how-to/quality-control.md) — проверка читаемости
- [export-rf-cosmetics.md](../../how-to/export-rf-cosmetics.md) — процесс для освежителей
