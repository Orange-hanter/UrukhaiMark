...
Происхождение статуса 50 и полный набор промежуточных статусов в текущих материалах
не подтверждены. Клиент хранит raw status и блокирует неизвестный переход; вопрос
ведётся как A02 в [architecture-validation.md](../../planning/architecture-validation.md).
