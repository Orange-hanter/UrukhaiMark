...
> Наличие и обязательность `manufacture_date` именно в `addMark` должны быть
> подтверждены актуальной схемой sandbox (A03). Пример не является заменой
> первичной OpenAPI/PDF-спецификации.
...
См. [troubleshooting.md](../../how-to/troubleshooting.md).
